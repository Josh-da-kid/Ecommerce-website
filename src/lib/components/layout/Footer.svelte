				...
				<div class="flex gap-4">
					{#each socialLinks as social}
						<a
							...
							class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 transition-colors hover:bg-accent"
						>
			...
			<div>
				...
				<ul class="space-y-3">
					{#each footerLinks.shop as link}
						<li>
							<a href={link.href} class="text-gray-400 transition-colors hover:text-accent">
								{link.label}
							</a>
						</li>
					{/each}
		...
		>
			...
			<div class="flex items-center gap-6">
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="flex items-center gap-2 text-gray-400 transition-colors hover:text-accent"
				>
					<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
						<path
					...
					<span class="text-sm">+234 9063497162</span>
				</a>
			</div>
		</div>
	</div>
