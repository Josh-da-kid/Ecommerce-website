	...
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		...
		{:else}
			...
			{#if pastOrders.length > 0}
				<div>
					<h2 class="mb-6 text-2xl font-semibold text-text-primary">Order History</h2>
					<div class="space-y-6">
		...
		<div class="p-6">
			...
			<div class="space-y-4">
				{#each order.items as item (item.productId)}
					<div class="flex items-center gap-4">
						<div class="h-16 w-16 flex-shrink-0 overflow-hidden rounded-xl bg-bg-secondary">
							<img
						...
						<div class="min-w-0 flex-1">
							<p class="truncate font-medium text-text-primary">{item.productName}</p>
